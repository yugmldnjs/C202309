...
// 학생별 평균성적 출력 함수 정의
void printStudentResult(double studentScores[][SUBJECTS], char studentNames[][CHARNUM]) {
...
// 과목별 평균성적 출력 함수 정의
void printSubjectResult(double studentScores[][SUBJECTS], char subjectNames[][CHARNUM]) {
